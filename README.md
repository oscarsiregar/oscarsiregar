<h1 align="center">Hi 👋, I'm Oscar Solideo Siregar</h1>
...
<p align="center">
  <i>"Learning is a process that never ends."</i>
</p>
...
I'm a Software Engineer who builds systems that are not only functional, but **reliable, scalable, and maintainable**.

My journey started from a strong backend foundation — designing APIs, managing data flows, and integrating complex systems. Over time, I expanded into fullstack development, enabling me to deliver **end-to-end solutions** that connect backend architecture with modern user interfaces.

I’ve worked across **fintech, automation platforms, and data-driven applications**, where performance, reliability, and system integrity are critical.

What I enjoy most is solving complex problems — from system architecture design to performance optimization and multi-service integrations.
...
<p align="center">
  ⚡ "I build systems that solve real business problems — not just code."
</p>
